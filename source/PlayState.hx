...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'fieldDamaged': //Week J
				var fieldDamaged:BGSprite = new BGSprite('fieldDamaged', -125, -200, 0.9, 0.9);
				add(fieldDamaged);

			case 'fieldDestroyed': //Week J
				var fieldDestroyed:BGSprite = new BGSprite('fieldDestroyed', -125, -200, 0.9, 0.9);
				add(fieldDestroyed);

			case 'fieldPhase2': //Week J
				var fieldPhase2:BGSprite = new BGSprite('fieldPhase2', -125, -200, 0.9, 0.9);
				add(fieldPhase2);

			case 'fieldFinale': //Week K
				var fieldFinale:BGSprite = new BGSprite('fieldFinale', -125, -200, 0.9, 0.9);
				add(fieldFinale);

			case 'fieldGlitched': //Week K
				var fieldGlitched:BGSprite = new BGSprite('fieldGlitched', -125, -200, 0.9, 0.9);
				add(fieldGlitched);

			case 'feld': //WeekR
				var feld:BGSprite = new BGSprite('feld', -125, -200, 0.9, 0.9);
				add(feld);
